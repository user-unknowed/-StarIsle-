 ...
 *
 * 罗夏卡片 (Rorschach inkblot): 10 张 (sys_ro1 ~ sys_ro10) — 完整经典 10 卡
 * TAT 卡片 (Thematic Apperception Test Murray): 10 张 (sys_tat1 ~ sys_tat10) — 覆盖青少年常见主题
 *
 * v2.1.1 扩展：从 12 张扩展到 20 张，补齐罗夏完整 10 卡 + 新增 4 张青少年主题 TAT，
 * 对齐 PRD「12-18 岁初高中生」目标用户与心理测评反馈小程序投射测评需求。
 *
 * 用法：
...
// TAT 10 张 — 选取 Murray 经典卡片中常见的主题卡（仅场景描述，非版权扫描图）
// 7-10 为青少年主题新增卡，对齐 PRD 12-18 岁目标用户
const tatList = [
  {
    n: 1,
